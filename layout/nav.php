<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="?">
      ...
      <span class="ms-1 font-weight-bold">Booking Futsal</span>
    </a>
  </div>
  ...
  <!-- <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main"> -->
    <ul class="navbar-nav">
      ...
      <?php if ($_SESSION['level']=='admin'): ?>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='transaksi'?'active':'' ?> " href="?module=transaksi">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='laporan'?'active':'' ?> " href="?module=laporan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='lapangan'?'active':'' ?> " href="?module=lapangan">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Master Lapangan</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item" hidden>
          <a class="nav-link <?php echo $_GET['module']=='setting'?'active':'' ?> " href="?module=setting">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <?php if ($_SESSION['level']=='customer'): ?>
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='transaksi' && $_GET['act']=='create' ?'active':'' ?> " href="?module=transaksi&act=create">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='transaksi' && $_GET['act']!=='create' ?'active':'' ?> " href="?module=transaksi&act=history">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo $_GET['module']=='user'?'active':'' ?> " href="?module=user&act=edit&id=<?php echo $_SESSION['id'] ?>">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link  <?php echo $_GET['module']=='tables'?'active':'' ?>" href="tables.html">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
